...
import { StorageCalculator, PvCalculator } from './storageCalculator';
...
async function demonstrateStorageCalculation() {
  ...
  const testInput = {
    ...
    monthlyConsumption_kwh: 75_000 / 12  // ~6.250 kWh/Monat
  };
...
async function demonstratePvCalculation() {
  ...
  for (const [label, data] of [
    ...
    const d = data as typeof combined.pvOnly;
